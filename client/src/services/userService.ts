...
export async function verifyUserWithServer(): Promise<{ uid: string }> {
  ...
  const res = await fetch('https://2e16-2a06-c701-ca9a-4b00-a8ac-16fe-e48f-fc17.ngrok-free.app/users/verify', {
    method: 'GET',
    headers: {
      Authorization: `Bearer ${token}`,
    },
...
export async function saveUserPreferences(uid: string, preferences: any): Promise<void> {
  ...
  const res = await fetch(`https://2e16-2a06-c701-ca9a-4b00-a8ac-16fe-e48f-fc17.ngrok-free.app/users/${uid}/preferences`, {
    method: 'POST',
    headers: {
      'Content-Type': 'application/json',
      Authorization: `Bearer ${token}`,
...
export async function getUserProfile(uid: string): Promise<any> {
  ...
  const res = await fetch(`https://2e16-2a06-c701-ca9a-4b00-a8ac-16fe-e48f-fc17.ngrok-free.app/users/profile`, {
    headers: {
      Authorization: `Bearer ${token}`,
    },
  });
